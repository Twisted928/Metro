 ...
 * @since 1.0.0
 */
public class InsureChecklistVO extends BaseEntity implements Serializable {
    ...
    public Integer getIfUpdata() {
        return ifUpdata;
    }

    public void setIfUpdata(Integer ifUpdata) {
        this.ifUpdata = ifUpdata;
    }
