...
public class SysDeptController extends BaseController
{
    ...
    @GetMapping("/export")
    public Result export(SysDept dept){
        List<SysDept> depts = deptService.selectDeptList(dept);
        ExcelUtil util=new ExcelUtil(SysDept.class);
        return util.exportExcel(depts,"部门数据");
    }
    ...
    public Result edit(@Validated @RequestBody SysDept dept)
    {
        ...
        {
            return Result.error("修改部门'" + dept.getDeptName() + "'失败，上级部门不能选择本身");
        }
