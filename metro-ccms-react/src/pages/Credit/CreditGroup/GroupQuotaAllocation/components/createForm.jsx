...
const CreateForm = ({ dispatch, loadingMem, commonmodel: { memberlList, memPagination } }) => {
  const ref = useRef();
  ...
  const cardList = {
    ...
    getCardList: (data) => {
      setNewcardList([...newcardList, ...data]);
    },
  };
  ...
  return (
    <PageContainer ghost title={false}>
      ...
      <Card title="申请单信息" extra={toolBarRender} style={{ marginTop: '24px' }}>
        <ProTable
          headerTitle=""
          rowKey="id"
          bordered
