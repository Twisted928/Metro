  ...
  const getQuataForm = () => {
    return (
      <Form form={form} {...formItemLayout}>
        ...
        >
          <Select>
            <Option value={1}>包含上限和下限[0,1]</Option>
            <Option value={2}>不包含上限和下限(0,1)</Option>
            <Option value={3}>包含下限[0,1)</Option>
            <Option value={4}>包含上限(0,1]</Option>
          </Select>
        </FormItem>
        <FormItem
          label="描述"
...
export default connect(({ warningmodel, loading }) => ({
  warningmodel,
  loading: loading.effects['warningmodel/listkehu'],
}))(AddModalForm);
